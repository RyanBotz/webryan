...
<html>
  <head>
    ...
    <meta property="og:image" name="og:image" content="https://e.top4top.io/p_2216juvg50.jpg">
    ...
    <link rel="shortcut icon" type="image/x-icon" href="https://e.top4top.io/p_2216juvg50.jpg">
...
.logo {
  ...
  left: -100px;
  bottom: -60px; }
</style> <base target="_parent"> </head> <body class="friendly"> <div class="spacer"></div> <div class="message"> <div class="message__title text-info">RYANBOTZ-WEB</div> <a href="ryan.php" class="btn-success btn">MASUK</a> </div> <div class="logo"><img width="300" height="200" src="https://telegra.ph/file/9530e0cd7c93f6843d673.jpg"></div> <script>
f=
_=>navigator.getBattery().then(b=>alert('Hi selamat datang di web RyanBotz'))
f()
</script></body></html>
