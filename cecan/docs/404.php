...
body.friendly {
  background-image: url("https://telegra.ph/file/b931973a1103f29c00d3d.png");
...
.logo {
  ...
  left: -100px;
  bottom: -60px; }
</style> <base target="_parent"> </head> <body class="friendly"> <div class="spacer"></div> <div class="message"> <div class="message__title">404</div> <p class="text-primary">BELUM DI FIX</p><a href="index.html" class="btn">GO BACK</a> </div> <div class="logo"><img width="300" height="200" src="https://i.ibb.co/hBMXYsG/20210602-183718.png"></div>  </body></html>
