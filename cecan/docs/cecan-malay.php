...
$url = "https://ryan-restapi.herokuapp.com/docs/cecan/malaysia?apikey=Alphabot";
...
<head>
    ...
    <link rel="shortcut icon" href="https://e.top4top.io/p_2216juvg50.jpg" />
				...
				<title>CECAN MALAYSIA</title>
</head>
<body align="center">
			
	<div class="hnti">		
				<h1>CECAN MALAYSIA</h1>				
				<img src="<?= $img ?>" alt="">
				<button type="submit">
				<a class="next" href="cecan-malay.php">NEXT</a>
      </button>	
	</div>		
